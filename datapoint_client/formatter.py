...
from datapoint_client.definitions import FIELD_DESCRIPTORS, FORECAST_FIELD_DESCRIPTORS
...
class ObsFormatter(Formatter):
    ...
    def _format(self, descriptor, code):
        return (
            FIELD_DESCRIPTORS[descriptor]["description"],
            FIELD_DESCRIPTORS[descriptor].get(code, "Unknown"),
        )
...
class WeatherFormatter(Formatter):
    ...
    def _format(self, descriptor, code):
        return (
            FORECAST_FIELD_DESCRIPTORS[descriptor]["description"],
